<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormPosition.aspx.cs" Inherits="NightCrow.FormPosition" %>
...
<body>
    <form id="Position" runat="server">
        ...
        <div>
			...
			<center>
                <asp:Label ID="lblPageStaff" runat="server" Font-Names="Arial" Font-Size="23" Font-Bold="true" Text="Должность" Width="300"></asp:Label>
                <br />
                <br />
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:GridView ID ="gvPosition" runat ="server" AllowSorting ="true" CurrentSortField ="" CurrentSortDirection ="ASC" OnRowDataBound="gvPosition_RowDataBound" OnSelectedIndexChanged="gvPosition_SelectedIndexChanged" OnSorting="gvPosition_Sorting" >
                    <Columns>
            ...
            <asp:Label ID="lblEmployeesPosition" runat="server" Font-Names="Arial" Font-Size="15" Text="Должность подчинённого: " Width="190"></asp:Label>
            <asp:TextBox ID="tbEmployeesPosition" runat="server" Font-Names="Arial" Font-Size="12" Width="300" MaxLength="20"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lblSalary" runat="server" Font-Names="Arial" Font-Size="15" Text="Оклад: " Width="190"></asp:Label>
            <asp:TextBox ID="tbSalary" runat="server" Font-Names="Arial" Font-Size="12" Width="300" MaxLength="20"></asp:TextBox>
            <br />
            <br />
            <br />
            <br />
