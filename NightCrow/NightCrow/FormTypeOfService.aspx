<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormTypeOfService.aspx.cs" Inherits="NightCrow.FormTypeOfService" %>
...
<body>
    <form id="TypeOfService" runat="server">
		<asp:SqlDataSource ID="sdsTypeOfService" runat ="server"></asp:SqlDataSource>
        <div>
			...
			<center>
                <asp:Label ID="lblPageStaff" runat="server" Font-Names="Arial" Font-Size="23" Font-Bold="true" Text="Тип услуги" Width="300"></asp:Label>
                <br />
                <br />
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:GridView ID ="gvTypeOfService" runat ="server" AllowSorting ="true" CurrentSortField ="" CurrentSortDirection ="ASC" OnRowDataBound="gvTypeOfService_RowDataBound" OnSelectedIndexChanged="gvTypeOfService_SelectedIndexChanged" OnSorting="gvTypeOfService_Sorting" >
                    <Columns>
